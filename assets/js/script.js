...
function clickPasswordField() {
  document.getElementById('pw-input').removeAttribute('onclick');
  document.getElementById('user-password').removeAttribute('onfocus');
  let togglePassword = document.getElementById('toggle-password');
  togglePassword.innerHTML = renderVisibilitySvg();
  togglePassword.setAttribute('onclick','togglePasswordImage()');
  togglePassword.classList.add('toggle-password-visibility');
}
...
function renderHtmlTemplate() {
  ...
  <div class="underline border-radius-8"></div>
    <form onsubmit="login(event)">
      ...
      <div class="pw-input" id="pw-input" onclick="clickPasswordField()">
        <input id="user-password" minlength="5" type="password" placeholder="Password" name="userPassword" onfocus="clickPasswordField()" required/>
