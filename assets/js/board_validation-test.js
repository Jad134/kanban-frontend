                    ...
                    <div class="left-right-container">
                        <div class="left-side">
                            ...
                            <div class="description">
                                ...
                                <textarea placeholder="Enter a Description" name="" id="description-textarea"
                        ...
                        <div class="right-side">
                            ...
                            <div class="category-container">
                                ...
                                <select name="Select contacts to assign" id="select-category" required>
                            ...
                            <div id="subtask-container" class="subtask-container">
                                ...
                                <div class="create-buttons">
                                    ...
                                    <button type="submit" id="create-btn">Create Task <img
